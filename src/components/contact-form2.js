 ...
 */
class ContactForm2 extends LitElement {
  _render({prop1}){
    return html`
      ${SharedStyles}
      <style>
    ...
    <div class="wrap-contact100">
      <form class="contact100-form validate-form">
        ...
        <div class="wrap-input100 validate-input" data-validate = "Phone is required">
          <input class="input100" id="phone" type="text" name="phone" placeholder="Assunto">
...
window.customElements.define('contact-form2', ContactForm2);